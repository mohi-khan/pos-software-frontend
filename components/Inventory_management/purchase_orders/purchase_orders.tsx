...
import { Plus, Search, Trash2, ArrowLeft, FileDown } from "lucide-react"
...
const PurchaseOrders = () => {
  ...
  const handleReceiveQuantityChange = (itemId: string, value: string) => {
    ...
    setReceiveItems((prev) => prev.map((item) => (item.itemId === itemId ? { ...item, toReceive: numValue } : item)))
  }
  ...
  const handleConfirmReceive = () => {
    ...
    setPurchaseOrders((prev) => prev.map((order) => (order.id === selectedOrder.id ? updatedOrder : order)))
    ...
    return (
      <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
        ...
        <div>
          ...
          />
          <p className="text-xs text-muted-foreground mt-1">{formData.notes?.length || 0} / 500</p>
        </div>
      ...
      <>
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <Button onClick={handleCreateNew} className="bg-green-500 hover:bg-green-600">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold">{selectedOrder?.orderNumber}</h1>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleReceive} className="bg-green-500 hover:bg-green-600">
              RECEIVE
            </Button>
          </div>
        </div>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="link" onClick={handleMarkAllReceived} className="text-sm">
                MARK ALL RECEIVED
              </Button>
            </div>
          </DialogHeader>
