...
//                   <button
//                     onClick={exportToCSV}
//                     className="text-gray-700 font-medium px-3 py-2 hover:bg-gray-100 rounded text-sm border"
//                   >
//                     EXPORT
//                   </button>
//                 </>
...
//                     item.variantSku.map((sku: GetItem, idx: number) => (
//                       <tr
...
const InventoryManagement: React.FC = () => {
  ...
  const uniqueCategories = categoriesData?.map(cat => cat.name) || []
  ...
  if (error || categoriesError) {
    return (
      <div className="min-h-screen bg-gray-50 mt-10 border-t-2 border-green-500 flex items-center justify-center">
        <div className="text-lg text-red-600">
          Error loading inventory: {error?.message || categoriesError?.message}
        </div>
      </div>
    )
  }
